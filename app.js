...
// --- Preload Assets ---
        (function preloadAssets() {
            ...
            const audioPath = 'first_light_particles_0.wav';
        ...
        const AppSettings = {
            ...
            musicUrl: 'first_light_particles_0.wav',
            ...
            let resultHTML = `
                <div class="glass-panel" style="width: 100%; max-width: 800px; padding: 30px;">
                    ...
                    <div class="result-scroll-area">
                        ...
                        <button class="btn" id="restartBtn" style="display: none; margin: 30px auto 0; opacity: 0; transition: opacity 1.5s ease 0.8s;">重新占卜</button>
                    </div>
                </div>
                <style>
                    .magic-loading-text {
